            ...
            if (closestGrabbable != null)
            {
                ...
                else
                {
                    ...
                    if (m_grabbedObj.snapOffset)
                    {
                        ...
                        if (m_controller == OVRInput.Controller.LTouch) m_grabbedObjectRotOff = Quaternion.Inverse(m_anchorOffsetRotation);
                        if(m_targetCollider.tag == "weapon") m_grabbedObjectRotOff = Quaternion.Inverse(m_anchorOffsetRotation);
                    }
                }
